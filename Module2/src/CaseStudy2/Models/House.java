...
public class House extends Services {
    ...
    public House(String id, String nameService, double area, double rentCost, int maxNumberOfPeople, String typeRent, String roomStandard, String description, double poolArea, int floor) {
